...
const Blog = () => {
  ...
  const DeleteCard = (index) => {
    ...
    fetch(`http://localhost:3000/blog/${index}`, { method: "DELETE" }).then(
      ...
      <BlogBox sx={{ mb: { xs: "0", sm: "0", md: "300px" }, mt: "3rem" }}>
        ...
        <Grid
          ...
          sx={{
            display: "flex",
            justifyContent: `${
              newData?.length > 2 ? "space-between" : "center"
            }`,
            rowGap: { md: "55vh", xl: "35vh", xs: "0" },
            flexWrap: "wrap",
        ...
        >
          {newData?.map((items, index) => (
            <Grid
              ...
              key={index}
            >
              <Card sx={{ height:{xs:'34rem', md:"25rem"} }}>
                <CardMedia
                  component="img"
                  src={items.image}
                  sx={{
